...
function App() {
  ...
  if (user.tipo === "estudiante") {
    return <div className="flex items-center justify-center h-screen text-2xl">Bienvenido estudiante {user.nombre}</div>;
  }
  if (user.tipo === "profesor") {
    return <div className="flex items-center justify-center h-screen text-2xl">Bienvenido profesor {user.nombre}</div>;
  }
