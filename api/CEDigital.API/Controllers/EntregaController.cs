...
namespace CEDigital.API.Controllers
{
    ...
    public class EntregaController : ControllerBase
    {
        ...
        [HttpGet("descargar/{id}")] // Descarga el archivo entregable para una entrega específica
        public async Task<IActionResult> DownloadEntrega(int id)
        {
            ...
            return File(fileStream, contentType, entrega.RutaEntregable); // Return the file with its original name
        }
    }
}
